 ...
 */
typedef int32_t (*send_callback_t)(const uint32_t _id, const uint8_t *const _buf, const uint8_t _size);

/**
 * @brief  Get current system time in milliseconds callback function type.
 */
typedef uint32_t (*sys_time_callback_t)(void);

/**
 * @brief Print debug information callback function type.
 */
typedef void (*debug_callback_t)(const char* _info, ...);
...
typedef struct IsoTpLink {
	...
	void (*indication_callback) (struct IsoTpLink *const _link, const uint8_t *const _buf, const uint16_t _size);
 ...
 */
typedef void (*indication_callback_t)(IsoTpLink *const _link, const uint8_t *const _buf, const uint16_t _size);
 ...
 * @param sys_time_callback Get system time in milliseconds.
 ...
 *  - The return value of the user shim callback function send_callback_t.
 */
