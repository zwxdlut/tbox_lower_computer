...
/**
 * @defgroup Word/Half word operation.
 * @{
 */
...
/** @} */ /* End of group Word/Half word operator. */

/**
 * @defgroup OBD-II Mode.
 * @{
 */
...
/** @} */ /* End of group OBD-II Mode. */

/**
 * @defgroup UDS service id and sub-function parameter operation.
 * @{
 */
...
/** @} */ /* End of group UDS service id and sub-function parameter operation. */
...
/** @} */ /* End of group UDS NRC. */

/**
 * @defgroup Diagnostic session control sub-function.
 * @{
 */
...
/** @} */ /* End of group Diagnostic session control sub-function. */

/**
 * @defgroup ECU Reset sub-function.
 * @{
 */
...
/** @} */ /* End of group ECU Reset sub-function. */

/**
 * @defgroup Read DTC information sub-function.
 * @{
 */
...
/** @} */ /* End of group Read DTC information sub-function. */

/**
 * @defgroup Security access sub-function.
 * @{
 */
...
/** @} */ /* End of group Security access sub-function. */

/**
 * @defgroup Communication control sub-function.
 * @{
 */
...
/** @} */ /* End of group Communication control sub-function. */

/**
 * @defgroup Read data by periodical identifier sub-function.
 * @{
 */
...
/** @} */ /* End of group Read data by periodical identifier sub-function. */

/**
 * @defgroup Dynamically define data identifier sub-function.
 * @{
 */
...
/** @} */ /* End of group Dynamically define data identifier sub-function. */

/**
 * @defgroup Routine control sub-function.
 * @{
 */
...
/** @} */ /* End of group Test present sub-function. */

/**
 * @defgroup Test present sub-function.
 * @{
 */
...
/**
 * @defgroup Control DTC setting sub-function.
 * @{
 */
#define UDS_CTRL_DTC_SETTING_SF_ON                                                   0x01
#define UDS_CTRL_DTC_SETTING_SF_OFF                                                  0x02
#define UDS_CTRL_DTC_SETTING_SF_NUM                                                  2
/** @} */ /* End of group Control DTC setting sub-function. */

/**
 * @defgroup Link control sub-function.
 * @{
 */
...
/** @} */ /* End of group Link control sub-function. */

/**
 * @defgroup DTC format identifier.
 * @{
 */
...
/** @} */ /* End of group DTC format identifier. */
...
/** @} */ /* End of group DTC group. */

/**
 * @defgroup DTC status mask.
 * @{
 */
...
/**
 * @defgroup DTC snapshot data identifier.
 * @{
 */
#define VSDID                                                                        0xDF01
#define ECUVDID                                                                      0xDF02
/** @} */ /* End of group DTC snapshot data identifier. */

/**
 * @defgroup DTC snapshot data length.
 * @{
 */
#define VS_LEN                                                                       2
#define ECUV_LEN                                                                     2
/** @} */ /* End of group DTC snapshot data length. */

/**
 * @defgroup DTC snapshot and data number.
 * @{
 */
#define DTC_SNAPSHOT01_DID_NUM                                                      2
#define DTC_SNAPSHOT_NUM                                                            1
/** @} */ /* End of group DTC snapshot and data number. */

/**
 * @defgroup DTC extend data number and length.
 * @{
 */
#define DTC_EXTEND_DATA01_LEN                                                        2
#define DTC_EXTEND_DATA_NUM                                                          1
/** @} */ /* End of group DTC extend data number and length. */

/**
 * @defgroup Read/Write data identifier.
 * @{
 */
...
/** @} */ /* End of group Read/Write data identifier. */

/**
 * @defgroup Read/Write data length.
 * @{
 */
#define TBTN_LEN                                                                     15
#define IMEI_LEN                                                                     15
...
#define SNOET_LEN                                                                    10
/** @} */ /* End of group Read/Write data length. */

/**
 * @defgroup Security access level.
 * @{
 */
...
/** @} */ /* End of group Security access level. */

/**
 * @defgroup Communication control message type mask.
 * @{
 */
#define COMM_MSG_TYPE_MASK_NCM                                                       0x01
#define COMM_MSG_TYPE_MASK_NWMCM                                                     0x02
/** @} */ /* End of group  Communication control message type mask. */

/**
 * @defgroup Routine identifier.
 * @{
 */
...
/** @} */ /* End of group Routine identifier. */

/**
 * @defgroup Routine status.
 * @{
 */
#define ROUTINE_STATUS_CORRECT                                                      0
#define ROUTINE_STATUS_INCORRECT                                                    1
/** @} */ /* End of group Routine status. */
