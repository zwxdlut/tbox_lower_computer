...
/**
 * @defgroup Application layer timer parameter.
 * @{
 */
static bool     g_s3_server_timer_started = false;
static uint32_t g_s3_server_timer = 0;
/** @} */ /* End of group Application layer timer parameter. */

/**
 * @defgroup Sub-function defines.
 * @{
 */
/**
 * @brief Sub-function.
...
/** @} */ /* End of group Sub-function defines */

/**
 * @defgroup Services defines.
 * @{
 */
/**
 * @brief Service.
...
/** @} */ /* End of group Services defines. */

/**
 * @defgroup Diagnostic session control.
 * @{
 */
static uint8_t g_session_mode = UDS_DIAG_SESSION_CTRL_SF_DEFAULT_MODE;
/** @} */ /* End of group Diagnostic session control. */
...
/** @} */ /* End of group DTC Snapshot. */

/**
 * @defgroup DTC extend data.
 * @{
 */
...
/**
 * @defgroup Read/Write data by identifier.
 * @{
 */
/**
...
#endif
/** @} */ /* End of group Read/Write data by identifier. */

/**
 * @defgroup Security access.
 * @{
 */
/**
...
/** @} */ /* End of group Security access. */

/**
 * @defgroup Communication control.
 * @{
 */
...
#endif
/** @} */ /* End of group Communication control. */

/**
 * @defgroup Routine control.
 * @{
 */
/**
...
/** @} */ /* End of group Routine control. */

/**
 * @defgroup Transfer data.
 * @{
 */
...
/** @} */ /* End of group Transfer data. */

/**
 * @defgroup Control DTC setting.
 * @{
 */
...
/**
 * @defgroup Diagnostic request handlers.
 * @{
 */
...
/** @} */ /* End of group Diagnostic request handlers. */
...
/**
 * @defgroup Diagnostic server callbacks default implementation.
 * @{
 */
...
/** @} */ /* End of group Diagnostic server callbacks default implementation. */
