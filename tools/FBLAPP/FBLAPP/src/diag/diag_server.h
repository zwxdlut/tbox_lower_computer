 ...
 * @param [in] sys_time_callback Get system time in milliseconds.
 * @param [in] debug_callback    Print debug info.
 */
...
/**
 * @defgroup Diagnostic server callbacks.
 * @{
...
/** @} */ /* End of group Diagnostic server callbacks. */
