#ifndef __DIAG_SERVER_CONFIG_APP_H__
#define __DIAG_SERVER_CONFIG_APP_H__
...
#define UDS_CONFIG_SECURITY_ACCESS			UDS_SID_SECURITY_ACCESS          ,true  ,false ,false ,true  ,true  ,true  ,false ,UDS_SECURITY_ACCESS_NONE ,UDS_SECURITY_ACCESS_SF_NUM
#define UDS_CONFIG_COM_CTRL					UDS_SID_COM_CTRL                 ,true  ,true  ,false ,true  ,true  ,true  ,false ,UDS_SECURITY_ACCESS_NONE ,UDS_COM_CTRL_SF_NUM
...
#define UDS_CONFIG_WRITE_DATA_BY_ID			UDS_SID_WRITE_DATA_BY_ID         ,true  ,false ,false ,true  ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE ,0u
...
#define UDS_CONFIG_REQT_DOWNLOAD				UDS_SID_REQT_DOWNLOAD            ,false ,false ,false ,true  ,false ,false ,true  ,UDS_SECURITY_ACCESS_NONE ,0u
#define UDS_CONFIG_REQT_UPLOAD				UDS_SID_REQT_UPLOAD              ,false ,false ,false ,true  ,false ,false ,true  ,UDS_SECURITY_ACCESS_NONE ,0u
#define UDS_CONFIG_TRANSFER_DATA				UDS_SID_TRANSFER_DATA            ,false ,false ,false ,true  ,false ,false ,true  ,UDS_SECURITY_ACCESS_NONE ,0u
#define UDS_CONFIG_REQT_TRANSFER_EXIT			UDS_SID_REQT_TRANSFER_EXIT       ,false ,false ,false ,true  ,false ,false ,true  ,UDS_SECURITY_ACCESS_NONE ,0u
...
#define UDS_CONFIG_CTRL_DTC_SETTING			UDS_SID_CTRL_DTC_SETTING         ,true  ,true  ,false ,true  ,true  ,true  ,false ,UDS_SECURITY_ACCESS_NONE ,UDS_CTRL_DTC_SETTING_SF_NUM
...
/** @} */ /* End of group UDS service config. */

/**
 * @defgroup UDS sub-function config.
 * @{
 *
...
{UDS_DIAG_SESSION_CTRL_SF_EXTEND_MODE  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_NONE},\
...
{UDS_SECURITY_ACCESS_SF_REQT_SEED_L1 ,true  ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE},\
{UDS_SECURITY_ACCESS_SF_SEND_KEY_L1  ,true  ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE},\
{UDS_SECURITY_ACCESS_SF_REQT_SEED_L2 ,true  ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE},\
{UDS_SECURITY_ACCESS_SF_SEND_KEY_L2  ,true  ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE},\
{UDS_SECURITY_ACCESS_SF_REQT_SEED_L3 ,true  ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE},\
{UDS_SECURITY_ACCESS_SF_SEND_KEY_L3  ,true  ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE},\
{UDS_SECURITY_ACCESS_SF_REQT_SEED_L4 ,false ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE},\
{UDS_SECURITY_ACCESS_SF_SEND_KEY_L4  ,false ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE}

/** Communication control sub-function list */ 
#define UDS_SF_CONFIG_COM_CTRL \
{UDS_COM_CTRL_SF_EN_RX_TX     ,true  ,false ,true  ,true ,UDS_SECURITY_ACCESS_NONE},\
...
{UDS_COM_CTRL_SF_DIS_RX_TX    ,true  ,false ,true  ,true ,UDS_SECURITY_ACCESS_NONE}
...
{UDS_ROUTINE_CTRL_SF_STOP         ,true  ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE},\
{UDS_ROUTINE_CTRL_SF_REQT_RESULTS ,true  ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE}

/** Routine control identifier configuration */
#define ROUTINE_CTRL_ID_CONFIG \
{HWORD_HIGH_BYTE(UDS_RID_ERASE_MEM)            ,HWORD_LOW_BYTE(UDS_RID_ERASE_MEM)            ,false ,false ,false ,UDS_SECURITY_ACCESS_NONE},\
{HWORD_HIGH_BYTE(UDS_RID_CHECK_PROM_DPED)      ,HWORD_LOW_BYTE(UDS_RID_CHECK_PROM_DPED)      ,false ,false ,false ,UDS_SECURITY_ACCESS_NONE},\
...
{HWORD_HIGH_BYTE(UDS_RID_CHECK_PROM_INTY)      ,HWORD_LOW_BYTE(UDS_RID_CHECK_PROM_INTY)      ,false ,false ,false ,UDS_SECURITY_ACCESS_NONE},\
{HWORD_HIGH_BYTE(UDS_RID_CHECK_PROM_PREC)      ,HWORD_LOW_BYTE(UDS_RID_CHECK_PROM_PREC)      ,false ,true  ,true  ,UDS_SECURITY_ACCESS_NONE},\
{HWORD_HIGH_BYTE(UDS_RID_CLEAN_TBOX_EOL)       ,HWORD_LOW_BYTE(UDS_RID_CLEAN_TBOX_EOL)       ,false ,false ,false ,UDS_SECURITY_ACCESS_L1}
...
{UDS_CTRL_DTC_SETTING_SF_ON  ,true ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE},\
{UDS_CTRL_DTC_SETTING_SF_OFF ,true ,false ,true ,true ,UDS_SECURITY_ACCESS_NONE}
...
/** @} */ /* End of group UDS sub-function config. */

#define DTC_STATUS_AVA_MASK 0x49 /**< DTC status available mask. */

/**
 * @defgroup Read/Write data by identifier config.
 * @{
 *
 ...
 * Security access level.
 */
#define RW_DATA_CONFIG_VMSPN     false ,true  ,false ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE
#define RW_DATA_CONFIG_SSID      false ,true  ,false ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE
#define RW_DATA_CONFIG_SNOET     false ,true  ,false ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE
#define RW_DATA_CONFIG_SSECUHWVN false ,true  ,false ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE
#define RW_DATA_CONFIG_SSECUSWVN false ,true  ,false ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE
#define RW_DATA_CONFIG_ECUSN     false ,true  ,false ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE
#define RW_DATA_CONFIG_VIN       false ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L1
#define RW_DATA_CONFIG_ADS       false ,true  ,false ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE
#define RW_DATA_CONFIG_ECUMD     false ,true  ,false ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE
#define RW_DATA_CONFIG_BSI       false ,true  ,false ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE
#define RW_DATA_CONFIG_EPSV      false ,true  ,false ,true  ,false ,true  ,UDS_SECURITY_ACCESS_NONE
#define RW_DATA_CONFIG_TBTN      true  ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L3
#define RW_DATA_CONFIG_IMEI      true  ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L3
#define RW_DATA_CONFIG_ICCID     false ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L3
#define RW_DATA_CONFIG_PK        true  ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L1
#define RW_DATA_CONFIG_EW        true  ,true  ,false ,false ,true  ,true  ,UDS_SECURITY_ACCESS_L1
#define RW_DATA_CONFIG_ED        false ,false ,false ,false ,true  ,false ,UDS_SECURITY_ACCESS_L1
#define RW_DATA_CONFIG_CIP       true  ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L3
#define RW_DATA_CONFIG_LIP       true  ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L3
#define RW_DATA_CONFIG_EIP       true  ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L3
#define RW_DATA_CONFIG_FP1       true  ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L2
#define RW_DATA_CONFIG_FP2       true  ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L2
#define RW_DATA_CONFIG_EOL       true  ,true  ,true  ,true  ,true  ,true  ,UDS_SECURITY_ACCESS_L2
/** @} */ /* End of group Read/Write data identifier config. */

#ifdef __cplusplus
}
#endif

#endif /* __DIAG_SERVER_CONFIG_APP_H__ */
