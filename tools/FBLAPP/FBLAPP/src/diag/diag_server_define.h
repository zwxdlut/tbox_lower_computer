 ...
 ******************************************************************************/
/**
 * @defgroup Diagnostic server address.
 * @{
 */
#define SERVER_RX_ID                                                                 0x729 /**< Server receive ID */
#define SERVER_TX_ID                                                                 0x7A9 /**< Server transmit ID. */
/** @} */ /* End of group Diagnostic server address. */

/**
 * @defgroup Server time.
 * @{
 */
...
/** @} */ /* End of group Server time. */

/**
 * @defgroup Security access request seed.
 * @{
 */
#define SECURITY_ACCESS_REQ_SEED_MAX_TRY_TIME                                        3
#define SECURITY_ACCESS_REQ_SEED_TIME_DELAY                                          10000 /**< Milliseconds. */
/** @} */ /* End of group Security access request seed. */

/**
 * @defgroup Battery voltage.
 * @{
 */
...
/**
 * @defgroup Message type's number.
 * @{
 */
...
/** @} */ /* End of group type's number. */

/**
 * @defgroup Message lost time in milliseconds.
 * @{
 */
...
/** @} */ /* End of group Message lost time in milliseconds. */

/**
 * @defgroup recovery time in milliseconds.
 * @{
 */
...
/** @} */ /* End of group Message recovery time in milliseconds. */

/**
 * @defgroup Read/Write initialization value.
 * @{
 */
...
#define SNOET                                                                        "TBOX"
/** @} */ /* End of group Read/Write data initialization value. */
...
/**
 * @defgroup Request download/upload block.
 * @{
 */
#define LENGTN_OF_BLOCK_LENGTH                                                        2
#define BLOCK_LENGTH                                                                  512
/** @} */ /* End of group Request download/upload block. */

/**
 * @defgroup Transfer data type.
 * @{
 */
#define TRANSFER_TYPE_INVALID                                                        0
#define TRANSFER_TYPE_DOWNLOAD                                                       1
#define TRANSFER_TYPE_UPLOAD                                                         2
/** @} */ /* End of group Transfer data type. */
